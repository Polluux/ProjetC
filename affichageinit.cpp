...
AffichageInit::AffichageInit(Core* c, string nom) : IAffichage()
{
...
void AffichageInit::updateElements(){
    ...
    QLineEdit *pseudo = new QLineEdit(QString::fromStdString(nomJoueur_));
    ...
    QPushButton *boutonJeu = new QPushButton("Goooo !");
