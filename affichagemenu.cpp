...
AffichageMenu::AffichageMenu(Core* c) : IAffichage()
{
    ...
    label->setPixmap(QPixmap("fonts/Title.jpg"));
    /*label->setText("Game");
    ...
    boutonQuitter->setStyleSheet("background-color:gray;outline: none");
    ...
    boutonMode1vs1->setStyleSheet("background-color:gray;outline: none");
